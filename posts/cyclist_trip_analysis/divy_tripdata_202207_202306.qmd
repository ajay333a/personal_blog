...
-   Download the data from ([Cyclist Trip Data](https://divvy-tripdata.s3.amazonaws.com/index.html)). Extract the zip folders and save them in a folder as `.csv` files.
